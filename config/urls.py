...
from estudos.views import (home, area_detail, categoria_detail, conteudo_detail, gerenciar, editar_area, editar_categoria, editar_conteudo, excluir_categoria, excluir_area, excluir_conteudo, buscar)
